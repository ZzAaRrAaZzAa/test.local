            ...
            <div x-cloak :class="[isOpen ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full']"
                ...
                <div class="flex flex-col -mx-6 lg:flex-row lg:items-center lg:mx-8">
                    <a href="{{ route('dashboard') }}"
                        class="px-3 py-2 mx-3 mt-2 text-gray-700 transition-colors duration-300 transform rounded-md lg:mt-0 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">Dashboard</a>
                    <a href="{{ route('admin.car.index') }}"
                        class="px-3 py-2 mx-3 mt-2 text-gray-700 transition-colors duration-300 transform rounded-md lg:mt-0 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">Adminpanel</a>
                </div>
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    ...
                    <h3 class="mx-2 text-gray-700 dark:text-gray-200 lg:hidden">ZakkaZZ media</h3>
                    </button>
                </div>
            </div>
        </div>
